...
#Esta função age antes do prompt ser enviado para a API do modelo
def before_model_callback(
    ...
    # Aqui é varrido de trás pra frente para encontrar o ultimo prompt do usuário
    last_user_message = ""
    ...
    # É salvado a última resposta no state do callback
    ...
    # Validação se existe a palavra proibida antes que chegue à llm
    ...
    # é salvado o momento em que foi feito a análise da ultima resposta
...
#Esta função recebe a resposta gerada pelo LLM e pode alterá-la antes que seja enviada pelo usuário 
# atuando como revisor
def after_model_callback(
    ...
    # estabelece quais palavras devem ser substituidas caso apareçam no prompt de resposta do modelo
    replacements = {
        "problem": "challenge",
        "difficult": "complex",
    }
