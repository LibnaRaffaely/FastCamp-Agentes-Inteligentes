...
# O funcionamento dessa ferramenta assemelha à presente no sales_agent
# tanto os metodos de validação quanto de salvamento de dados
# revendo os cursos comprados, usando uma regra de negócio, salvando contexto e salvando histórico de interação
def refund_course(tool_context: ToolContext) -> dict:
    ...
    # Checagem dos cursos possuidos pelo usuário
    course_ids = [
